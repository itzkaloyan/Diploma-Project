...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.13.4"
  WORKING_DIRECTORY "/home/andititan/code/basic_client_server/cppClientLib/build/_deps/catch2-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v2.13.4")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v2.13.4")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/andititan/code/basic_client_server/cppClientLib/build/_deps/catch2-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/andititan/code/basic_client_server/cppClientLib/build/_deps/catch2-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
